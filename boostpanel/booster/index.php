...
<head>
	...
	<title><?php echo $website; ?> - Booster area</title>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>Booster area</h1>
				<ol class="breadcrumb">
					<li><a href="#"><i class="fa fa-briefcase"></i> Booster area</a></li>
					...
					<div class="col-md-6 col-sm-6 col-xs-6">
						<div class="info-box">
							<span class="info-box-icon bg-aqua">
								<i class="fa fa-money" style="padding-top:22px"></i>
							</span>
					...
					<div class="col-md-6 col-sm-6 col-xs-6">
						<div class="info-box">
							<span class="info-box-icon bg-red">
								<i class="fa fa-clock-o" style="padding-top:22px"></i>
							</span>
							<div class="info-box-content">
								<span class="info-box-test">
									Payment pending
									...
									<tbody>
										...
										<?php foreach($orders as $order) { ?>
											<tr>
												...
												<td><?php echo $order['lol_server']; ?></td>
												<!-- DATE -->
												<td>
													<?php 
												...
												<td><?php $price = $order['order_price'] * ($perc['percentage'] / 100); echo $price; ?> €</td>
												<td><a onclick="return confirm('Are you sure?');" href="take.php?id=<?php echo $order['order_id']; ?>" class="btn btn-xs btn-primary">Take order</a></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>	
...
<script>
	...
	// Notify when the booster take an order
	var booster = <?php echo $_SESSION['booster']; ?>;
	if(booster == 1)
	{
		toastr.success('You took an order.', 'Order taken', {timeOut: 5000});
		<?php $_SESSION['booster'] = 0; ?>
	}

	// Notify he dropped an order
	var drop = <?php echo $_SESSION['drop']; ?>;
	if(drop == 1)
	{
		toastr.warning('The order has been dropped.', 'Order dropped', {timeout: 5000});
		<?php $_SESSION['drop'] = 0; ?>
	}

	// Notify the user he finished an order
	var finished = <?php echo $_SESSION['finished']; ?>;
	if(finished == 1)
	{
		toastr.success('You have finished your order.', 'Order finished', {timeout: 5000});
		<?php $_SESSION['finished'] = 0; ?>
	}
