								...
								<div class="box-body">
									...
									<div class="row ordersl" id="order_<?php echo $allOrder['order_id']; ?>" <?php echo $style; ?>>
										...
										<div class="col-md-4 col-sm-4 col-xs-4 text-center">
											<h4>Started</h4>
											<img class="img-order-details img-responsive" src="../assets/img/tiers/<?php echo $allOrder['start_league'] ;?>.png">
										...
										<div class="col-md-4 col-sm-4 col-xs-4 text-center">
											<h4>Current</h4>
											<img class="img-order-details img-responsive" style="width: 200px;" src="../assets/img/tiers/<?php echo $sl ;?>.png">
											<p style="margin-bottom: 0px;">
												<strong><?php if($allOrder['order_boost'] === "Division" || $allOrder['order_boost'] === 'Net Wins'){echo $allOrder['current_league']." ".$allOrder['current_division'];}else{echo $allOrder['current_league']; } ?></strong>
											</p>
											<p>League Points : <?php echo $lp; ?></p>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-4 text-center">
											<h4>Desired</h4>
											<img class="img-order-details img-responsive" src="../assets/img/tiers/<?php if($allOrder['order_boost'] === "Division"){echo $allOrder['desired_league'];}else{echo $allOrder['start_league']; } ;?>.png">
